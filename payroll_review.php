...
<title>Payroll- Review Employees</title>
        ...
        <div class="main">
            ...
            <main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row mb-2 mb-xl-3">
						<div class="col-auto d-none d-sm-block">
							<h3><strong>Payroll Processing - Review</strong> </h3>
						</div>                    
                    </div> 
                </div>
				...
				<div class="Emplist mb-2 mb-xl-3">
                    ...
                    <table id="payroll_review" class="display">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Image</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>02</td>
                                <td width="60px">
                                    <div class="imgBx"><img src="img/photos/Ronald.jpeg" alt=""></div>
                                </td>
                                <td>Mugisha</td>
                                <td>Ronald</td>
                                <td>24</td>
                            ...
                            <tr>
                                <td>03</td>
                                <td width="60px">
                                    <div class="imgBx"><img src="img/photos/Maya.jpeg" alt=""></div>
                                </td>
                                <td>Wamani</td>
                                <td>Derrick</td>
                                <td>24</td>
